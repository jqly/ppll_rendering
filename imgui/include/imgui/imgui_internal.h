...
// Helpers: Misc
IMGUI_API ImU32         ImHash(const void* __m128_data, int data_size, ImU32 seed = 0);    // Pass data_size==0 for zero-terminated strings
...
namespace ImGui
{
    ...
    IMGUI_API void          PlotEx(ImGuiPlotType plot_type, const char* label, float (*values_getter)(void* __m128_data, int idx), void* __m128_data, int values_count, int values_offset, const char* overlay_text, float scale_min, float scale_max, ImVec2 graph_size);
